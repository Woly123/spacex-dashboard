var gauge1 = Gauge(
  ...
  var gaugePressure = Gauge(
    document.getElementById("gauge-pressure"), {
      min: -50,
      max: 50,
      dialStartAngle: 180,
      dialEndAngle: 0,
  ...
  var gaugeEnergy = Gauge(
    document.getElementById("gauge-energy"), {
      max: 100,
      dialStartAngle: 90.01,
      dialEndAngle: 89.99,
      // dialRadius: 10,
  ...
  (function loop() {
    ...
    gauge7.setValueAnimated(value6, 1);
